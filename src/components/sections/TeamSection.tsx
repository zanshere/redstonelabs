...
import { Github, Instagram, Facebook, ExternalLink, Calendar } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            Kenali Tim Profesional
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Tim berkompeten yang dipersatukan oleh dedikasi untuk pengalaman
            digital unggul.
          </p>
        </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {(() => {
                            ...
                            if (
                              ...
                              member.position.toLowerCase().includes("frontend")
                            ) {
                              skills.push(
                                "React",
                                "TypeScript",
                              ...
                              member.position.toLowerCase().includes("backend")
                            ) {
                              skills.push(
                                "API Development",
                                "Database",
                              ...
                              member.position.toLowerCase().includes("ui/ux")
                            ) {
                              skills.push(
                                "User Research",
                                "Wireframing",
                              ...
                              member.position.toLowerCase().includes("security")
                            ) {
                              skills.push(
                                "Penetration Testing",
